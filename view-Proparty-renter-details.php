                                ...
                                <div class="col-md-12">
                                    <a href="#"><i class="fa fa-circle text-success"></i>&nbsp;&nbsp;Active Renter</a>
                                     <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <th>Payment(Rent)</th>
                                            <td><a href="Payment_details.php?id=<?php echo $w1['item_rent_id']; ?>" class="btn btn-success btn-md edit-data"><span class="fa fa-money">&nbsp;</span>Payment</a></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
...
<form action="add-Proparty-renter-details.php" method="post" style="margin-top: -500px;">
    <div class="content-wrapper">
        <!-- Main content -->
        <section class="content">
            <!-- /.box -->
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(@$w1['status']=='active') { ?>
                                  <a href="view-Proparty-renter-details.php?id=<?php echo $w1['item_id']; ?>&status=active"><i class="fa fa-circle text-success">Active</i></a>
                                <?php }
                                else {?>
                                    <a href="view-Proparty-renter-details.php?id=<?php echo $w1['item_id']; ?>&status=inactive"><i class="fa fa-circle text-red">Complated</i></a>
                                <?php } ?>
                            </td>
