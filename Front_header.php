    ...
    <div class="container">
        <div class="row site-hero-inner align-items-center">
            <div class="col-md-7 text-left ml-auto">
                ...
                <p class="sub-heading mb-5" data-aos="fade-up" data-aos-delay="100">Discover our world-class <b>HOME,FARMHOUSE,BUNGLOWS</b>.</p>
                <a href="Front_register.php" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block">Sign Up</a>
                <a href="Front_login.php" class="btn uppercase btn-primary mr-md-2 mr-0 mb-3 d-sm-inline d-block">Log in</a>
