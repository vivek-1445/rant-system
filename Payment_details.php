...
if(isset($_GET['deleteid'])) {
    ...
    $delete = "delete from renter_payment where `renter_payment_id`='$dataid'";
    $result = mysqli_query($database_connection, $delete);
...
{
    $id = $_GET['id'];
    $que = "update renter_payment set `payment_status`='complated' where `item_rent_id`='$id'";
