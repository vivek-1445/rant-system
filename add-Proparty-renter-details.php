        ...
        <section class="content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="renter_name"  id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Renter Name"   style="width:37%;">
                </div>
                <div class="form-group">
                    <label >Renter Mobile Number:</label>
                    <input type="number" class="form-control" name="renter_mobile_number" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Renter Mobile Number"   style="width:37%;">
                </div>
                <div class="form-group">
                    <div class="control-group">
                        <div class="controls" >
                            ...
                            <div ></div>
                            <textarea class="form-control" name="myTextarea" id="myTextarea" class="summernote" placeholder="Enter Renter Address" style="width: 37%; height: 120px;"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="control-group">
                        ...
                        <div class="controls" >
                            <input type="date"   class="form-control" name="rent_start_date" placeholder="Enter your rant start date" style="width: 37%;">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label >Totle Deposite Amount:</label>
                    <input type="number" class="form-control" name="deposite_amount" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Deposite Amount"   style="width:37%;">
                </div>
